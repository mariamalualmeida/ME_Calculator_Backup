...
- June 24, 2025: REORGANIZAÇÃO DEFINITIVA CONFORME SOLICITADO - botão importar dados visível no topo, configuração "Exibir dados de juros" unificada corretamente, painel administrativo reorganizado com estrutura exata solicitada: seções expansíveis (Financeiras com regras no início e tabela no final, Contratos organizados), credenciais sempre visíveis, remoção das opções avançadas de PDF não solicitadas, correção função getTemplateContratoDefault(), cache v=20250624210000 (v20250624210000)

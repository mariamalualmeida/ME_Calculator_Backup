...
- June 24, 2025: CORREÇÕES DEFINITIVAS IMPLEMENTADAS - corrigido erro PDF (obterTextoSistemaJuros inline), persistência login administrativo, validação completa de campos na inicialização/salvamento/cálculo (validarTodosOsCampos), bordas vermelhas respeitam modo livre, geração contratos funcional, onclick handlers corrigidos, sistema valida ao abrir página/salvar configurações/calcular, cache v=20250624390000 (v20250624390000)

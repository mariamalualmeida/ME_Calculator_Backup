...
- June 24, 2025: OPÇÕES AVANÇADAS DE PDF IMPLEMENTADAS - seção expansível com configurações completas: logo personalizado, data/hora de geração, informações extras configuráveis, 3 formatos de tabela (completa/simples/mínima), 5 cores de tema + personalizada, rodapé customizável, 3 tamanhos de fonte, correção da função getTemplateContratoDefault(), visibilidade aprimorada com cores temáticas, cache v=20250624200000 (v20250624200000)
